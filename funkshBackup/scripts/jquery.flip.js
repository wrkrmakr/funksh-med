...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: acceptHexColor(settings.color) || "#94c33b",
        ...
        flipObj = {
            ...
            toColor: acceptHexColor(settings.color) || "#94c33b",
            speed: settings.speed || 500,
            top: $this.offset().top,
        ...
        ie6 && (flipObj.transparent="#94c33b");
        ...
        var defaultVertical=function() {
            ...
            return {
                ...
                "first": {
                    ...
                    borderLeftColor: '#94c33b',
                    borderRightColor: '#94c33b',
